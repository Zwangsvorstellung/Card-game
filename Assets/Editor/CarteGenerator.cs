...
public class CarteGenerator
{
    ...
    public static void GenererCartes()
    {
        ...
        {
            (1, "Zao", "Agilité Risquée","Si Zao attaque, elle ne peut esquiver. Passive, elle est intouchable", 4, 3, 1, "ad0e0e"),
            ...
            (8, "Jaycota", "Provocation", "Si attaquée, inflige -1 DF à l’attaquant en représaille", 2, 6, 8, "6f0000"),
